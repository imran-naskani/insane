...
# st.title("📈 INSANE — Imran Naskani's Statistical Algorithm for Navigating Equities")

# ----------------------------------------------------
#  CUSTOM PAGE LAYOUT (NO SCROLLING)
# ----------------------------------------------------
st.markdown("""
<style>

/* Remove Streamlit default scrolling */
html, body, [data-testid="stAppViewContainer"] {
    height: 100vh !important;
    overflow: hidden !important;
}

/* Adjust main container to prevent expanding */
...
filters_col, main_col, spacer = st.columns([1, 4, 0.2])
...
with filters_col:
    ...
    capital = st.number_input("Capital ($)", 1000, 1000000, 10000, 500)

    run = st.button("Run Model", key="run_button")
